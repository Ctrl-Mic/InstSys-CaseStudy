...
class TeachingFacultyExtractor {
   ...
   */
  async extractTeachingFacultyExcelInfo(sheet) {
    try {
      ...
      const facultyInfo = this.extractUniversalTeachingFacultyData(allText, data.file_name);
   ...
   */
  extractUniversalTeachingFacultyData(textContent) {
...
export default TeachingFacultyExtractor;